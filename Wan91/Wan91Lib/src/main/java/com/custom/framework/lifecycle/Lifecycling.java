...
public class Lifecycling {
    ...
    static GenericLifecycleObserver getCallback(final Object object) {
        ...
        return new GenericLifecycleObserver() {
            @Override
            public void onStateChanged(@NonNull com.custom.framework.lifecycle.LifecycleOwner source,
    ...
    private static int resolveObserverCallbackType(Class<?> klass) {
        ...
        @SuppressWarnings("deprecation")
        boolean hasLifecycleMethods = com.custom.framework.lifecycle.ClassesInfoCache.sInstance.hasLifecycleMethods(klass);
