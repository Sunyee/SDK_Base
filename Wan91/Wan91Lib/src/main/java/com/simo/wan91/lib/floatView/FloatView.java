...
import com.simo.wan91.lib.user.UserPopActivity;
import com.simo.wan91.lib.utils.LayoutUtils;
import com.simo.wan91.lib.utils.CommonUtils;
import com.simo.wan91.lib.utils.ScreenUtils;
...
//        mFloatIcon.setImageBitmap(Constant.XFBitmap);
        ...
        tvWeiDu = rootFloatView.findViewById(LayoutUtils.getIdByName(context, "id", "tv_weidu"));
//        if(Constant.count!=0){
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                if(!isScroll && ((Math.abs(eventUpEndX - eventDownStartX) + Math.abs(eventUpEndY - eventDownStartY)) < (v.getMeasuredWidth()+v.getMeasuredHeight())/3)){
                    v.getLocationOnScreen(location);
//                    这里是点击事件
                    Intent intent = new Intent(mContext, UserPopActivity.class);
